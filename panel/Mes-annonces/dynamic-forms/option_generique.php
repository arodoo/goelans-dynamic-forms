        ...
        <div class="form-group row">
          <div class="col-12">
            <div class="custom-control custom-checkbox d-inline-block mr-4">
              <input type="checkbox" id="option_location_gerance" name="option_location_gerance"
                class="custom-control-input">
              <label class="custom-control-label" for="option_location_gerance">Location-Gérance</label>
            </div>
            <div class="custom-control custom-checkbox d-inline-block mr-4">
              <input type="checkbox" id="option_location_achat" name="option_location_achat"
                class="custom-control-input">
              <label class="custom-control-label" for="option_location_achat">Location-Gérance avec option
                d'achat</label>
            </div>
            <div class="custom-control custom-checkbox d-inline-block">
              <input type="checkbox" id="option_sous_location_commerciale" name="option_sous_location_commerciale"
                class="custom-control-input">
              <label class="custom-control-label" for="option_sous_location_commerciale">Sous location Local
                commercial</label>
            </div>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12 col-md-9">
            <div class="custom-control custom-radio d-inline-block mr-4">
              <input type="radio" id="duree_temporaire" name="duree_contrat" value="Temporaire"
                class="custom-control-input">
              <label class="custom-control-label" for="duree_temporaire">Temporaire</label>
            </div>
            <div class="custom-control custom-radio d-inline-block">
              <input type="radio" id="duree_renouvelable" name="duree_contrat" value="Renouvelable"
                class="custom-control-input">
